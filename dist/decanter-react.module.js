...
var getIconAnimation = function getIconAnimation(animate) {
  ...
  switch (animate) {
    case 'right':
      classes =  (classes, 'group-hocus:su-translate-x-02em');
      break;
...
export { Alert, Button, Container, CtaButton, CtaLink, DismissButton, FlexBox, FlexCell, GlobalFooter, Grid, GridCell, Heading, IdentityBar, LocalFooter, Lockup, Logo, Skiplink, SrOnlyText };
