...
var CtaLink = function CtaLink(_ref) {
  ...
  return /*#__PURE__*/React.createElement("a", _extends({
    ...
    href: link,
    ref: ref
  }, props), text, srText && /*#__PURE__*/React.createElement("span", {
    className: "su-sr-only"
  }, " ", srText), icon && /*#__PURE__*/React.createElement(Icon, {
    icon: heroicon,
    type: "solid",
    "aria-hidden": true,
...
export { Alert, Button, Container, CtaLink, CtaLinkButton, FlexBox, FlexCell, GlobalFooter, Grid, GridCell, Heading, IdentityBar, LocalFooter, Lockup, Logo, Skiplink, SrOnlyText };
