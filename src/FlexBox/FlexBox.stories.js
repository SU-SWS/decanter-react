...
const FlexBoxTemplate = ({ children, ...rest }) => {
  return (
    <FlexBox {...rest}>
      <div className="su-w-1/6 su-text-center su-bg-spirited su-type-3 su-font-bold su-p-10">1</div>
      <div className="su-w-1/6 su-text-center su-bg-spirited su-type-3 su-font-bold su-p-10">2</div>
